...
public class ConsumirWS {
    public static void main(String[] args) throws Exception{
        ...
        System.out.println(receptorCliente.getServico("Subtracao",5,2));
        System.out.println(receptorCliente.getCatalogo());
        
        System.out.println(receptorCliente.getServico("Divisao",50,5));
        System.out.println(receptorCliente.getCatalogo());
        
        System.out.println(receptorCliente.getServico("Raiz2",2,0));
        System.out.println(receptorCliente.getCatalogo());
